...
import { createUserWithEmailAndPassword, updateProfile } from 'firebase/auth'; // Importe a função do Firebase
...
export default function Cadastro({ navigation }) {
    ...
    const handleRegister = async () => {
        ...
        try {
            // 2. Tente criar o usuário no Firebase Authentication
            const userCredential = await createUserWithEmailAndPassword(auth, email, password);

            // 3. Salve o nome do usuário no perfil do Firebase Authentication
            await updateProfile(userCredential.user, {
                displayName: name
            });

            // 4. Salve os dados do usuário no Cloud Firestore
            ...
            Alert.alert('Sucesso!', 'Conta criada e dados salvos com sucesso!');
